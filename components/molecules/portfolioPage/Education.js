      ...
      <div className="">
        <div className="md:flex justify-between md:w-[90%] mx-2 md:mx-auto md:mt-5  mt-3 ">
          {props.portfolioData &&
            ...
            props.portfolioData.education.length > 0 && (
          ...
          {props.portfolioData &&
            ...
            props.portfolioData.skills.length > 0 && (
              <div className="md:max-w-[450px] mt-2 md:mt-0">
                <div className="font-bold text-[23px]  text-text_1  ">
                  Skills
                </div>
                    ...
                    return (
                      ...
                      >
                        <div className="capitalize font-semibold text-text_1 rounded-md">
                          {skill.skill},{" "}
                          <span className="text-sm text-text_1">
                            {skill.level}
                          </span>
