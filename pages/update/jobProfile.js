...
function JobProfile() {
    ...
    useEffect(() => {
        const auth = async () => {
            ...
            dispatch(getBasicDataActions.getBasicData({ userid: localStorage.getItem("userid"), requirement: "jobProfile" }));
        };
        auth();
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [])
    ...
    const pages = [
        ...
        { pageData: <BasicInfo onChange={onChange} userid={userid} data={userBasicData ? userBasicData : ""} />, id: 1 },
        { pageData: <Experience data={userBasicData ? userBasicData : ""} />, id: 2 },
        { pageData: <Education data={userBasicData ? userBasicData : ""} />, id: 3 },
        { pageData: <Projects data={userBasicData ? userBasicData : ""} />, id: 4 },
        { pageData: <Certificates data={userBasicData ? userBasicData : ""} />, id: 5 },
    ]
    return (
        <>
            <div className="md:h-screen  flex flex-col justify-start md:overflow-y-hidden">
                ...
                {userBasicData &&
                    <div className="h-[100%] ">
                        <UpdatePage userBasicData={userBasicData} buttons={[
